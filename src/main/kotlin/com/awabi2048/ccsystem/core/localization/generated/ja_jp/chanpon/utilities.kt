...
internal object JaJpChanponUtilitiesCatalog {
    ...
    private fun chunk1(): List<EmbeddedLocalizationEntry> = listOf(
        ...
        EmbeddedLocalizationEntry(key = "chanpon_utilities.command_safeguard.first_description", value = EmbeddedLocalizedValue.Text("影響範囲の大きいコマンドです。実行するには2回の確認が必要です。"), domain = DOMAIN),
        EmbeddedLocalizationEntry(key = "chanpon_utilities.command_safeguard.second_description", value = EmbeddedLocalizedValue.Text("本当にこのコマンドを実行しますか？確認ボタンの位置が入れ替わっています。"), domain = DOMAIN),
        ...
        EmbeddedLocalizationEntry(key = "chanpon_utilities.command_safeguard.target_count", value = EmbeddedLocalizedValue.Text("対象エンティティ: {targets}体 / 読み込み済みエンティティ: {total}体 ({percentage}%)"), domain = DOMAIN),
