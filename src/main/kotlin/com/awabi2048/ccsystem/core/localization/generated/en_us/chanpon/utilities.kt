...
internal object EnUsChanponUtilitiesCatalog {
    ...
    private fun chunk1(): List<EmbeddedLocalizationEntry> = listOf(
        ...
        EmbeddedLocalizationEntry(key = "chanpon_utilities.command_safeguard.first_description", value = EmbeddedLocalizedValue.Text("This command has a wide impact. It requires two confirmations to execute."), domain = DOMAIN),
        EmbeddedLocalizationEntry(key = "chanpon_utilities.command_safeguard.second_description", value = EmbeddedLocalizedValue.Text("Are you sure you want to execute this command? The button positions have been swapped."), domain = DOMAIN),
        ...
        EmbeddedLocalizationEntry(key = "chanpon_utilities.command_safeguard.target_count", value = EmbeddedLocalizedValue.Text("Target entities: {targets} / Loaded entities: {total} ({percentage}%)"), domain = DOMAIN),
