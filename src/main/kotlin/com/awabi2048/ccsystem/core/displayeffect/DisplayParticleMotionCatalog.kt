...
internal object DisplayParticleMotionCatalog {
    private val presets = listOf(
        ...
        DisplayParticleMotionPreset("cc:buoyant", DisplayParticleMotionKind.BUOYANT, DisplayEffectVector3(0.0, 0.002, 0.0), 0.96, turbulenceStrength = 0.0015, turbulenceFrequency = 0.22),
        DisplayParticleMotionPreset("cc:drift", DisplayParticleMotionKind.DRIFT, velocityRetentionPerTick = 0.97, turbulenceStrength = 0.0035, turbulenceFrequency = 0.16),
